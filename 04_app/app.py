...
st.set_page_config(
    page_title="FleetFit | Aircraft Model Recommendation",
    page_icon="✈",
    layout="wide",
...
def render_navigation(view: str) -> None:
    ...
    st.markdown(
        ...
        '<span class="logo-name">FleetFit</span></a>'
...
def render_footer() -> None:
    st.markdown(
        '<div class="fleet-footer">TFM Elias Ventura - UCM Master IA Data Science Big Data - 2026</div>',
        unsafe_allow_html=True,
    )
